#!/usr/bin/env python3
"""
Extract CLIP features for all images in RefCOCOg dataset with multiprocessing support.
"""
...
def extract_features_from_json(
    ...
    Args:
        json_file: Path to RefCOCOg JSON/JSONL file
        images_dir: Directory containing COCO images (train2014)
    ...
    for idx, entry in enumerate(data):
        ...
        if image_path:
            # Extract filename from path (e.g., "data/coco/train2014/COCO_train2014_000000131074.jpg" -> "COCO_train2014_000000131074.jpg")
...
def main():
    parser = argparse.ArgumentParser(description="Extract CLIP features for RefCOCOg images")
    parser.add_argument(
        "--json_file",
        type=str,
        default="/media/data2/maschan/internvl/data/refcocog/train.jsonl",
        help="Path to RefCOCOg JSON/JSONL file"
    )
    parser.add_argument(
        "--images_dir",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/home/maschan/ddfm/InternVL/clustering/refcocog",
