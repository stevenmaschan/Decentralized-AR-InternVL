#!/usr/bin/env python3
"""
Extract CLIP features for all images in RefCOCO+ dataset with multiprocessing support.
"""
...
def extract_features_from_json(
    ...
    Args:
        json_file: Path to RefCOCO+ JSON/JSONL file
    ...
    for idx, entry in enumerate(data):
        ...
        if image_path:
            # Extract filename from path (e.g., "data/coco/train2014/COCO_train2014_000000098304.jpg" -> "COCO_train2014_000000098304.jpg")
...
def main():
    parser = argparse.ArgumentParser(description="Extract CLIP features for RefCOCO+ images")
    parser.add_argument(
        "--json_file",
        type=str,
        default="/media/data2/maschan/internvl/data/refcoco+/train.jsonl",
        help="Path to RefCOCO+ JSON/JSONL file"
    )
    parser.add_argument(
        "--images_dir",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/home/maschan/ddfm/InternVL/clustering/refcoco_plus",
