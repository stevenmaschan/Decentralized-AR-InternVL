#!/usr/bin/env python3
"""
Extract CLIP features for all images in KVQA dataset with multiprocessing support.
"""
...
def extract_features_from_json(
    ...
    Args:
        json_file: Path to KVQA JSON/JSONL file
        images_dir: Directory containing KVQA images
...
def main():
    parser = argparse.ArgumentParser(description="Extract CLIP features for KVQA images")
    parser.add_argument(
        "--json_file",
        type=str,
        default="/media/data2/maschan/internvl/data/kvqa/train.jsonl",
        help="Path to KVQA JSON/JSONL file"
    )
    parser.add_argument(
        "--images_dir",
        type=str,
        default="/media/data2/maschan/internvl/data/kvqa/raw/KVQAimgs",
        help="Directory containing KVQA images"
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/home/maschan/ddfm/InternVL/clustering/kvqa",
