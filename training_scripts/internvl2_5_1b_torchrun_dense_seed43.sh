...
OUTPUT_DIR='work_dirs/internvl2_5_1b/dense_seed43'
...
# Dataset: dense (full, unclustered mixture) -- seed 43 (identical config to dense_seed42; only --seed differs)
