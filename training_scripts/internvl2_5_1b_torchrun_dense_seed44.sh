...
OUTPUT_DIR='work_dirs/internvl2_5_1b/dense_seed44'
...
# Dataset: dense (full, unclustered mixture) -- seed 44 (identical config to dense_seed42; only --seed differs)
...
torchrun \
  ...
  --meta_path "/lambda/nfs/virginia/internvl-data/dense/dataset_mixture.json" \
