...
OUTPUT_DIR='work_dirs/internvl2_5_1b/clusters-2_balanced-kmeans_vit-b-16_seed42/cluster-0'
...
# Dataset: clusters-2_balanced-kmeans_vit-b-16_seed42 / cluster-0
...
torchrun \
  ...
  --meta_path "/lambda/nfs/virginia/internvl-data/clusters-2_balanced-kmeans_vit-b-16_seed42/cluster-0/dataset_mixture.json" \
